...
```{r q4}
question_radio(
  "On a scale of 1 to 10 (1 = not very nervous, 10 = very nervous), how nervous are you feeling about learning R this semester?",
  ...
  correct = "Thank you for your feedback. We hope you have a great semester!",
  allow_retry = FALSE
)
```