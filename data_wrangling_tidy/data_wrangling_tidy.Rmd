...
Using the `filter` function, create a dataset containing only the counties in Illinois (IL). Call it `illinois_counties`. (Click the *Hints* button if you need a hint. You can see more hints by clicking *Next hint*.)
